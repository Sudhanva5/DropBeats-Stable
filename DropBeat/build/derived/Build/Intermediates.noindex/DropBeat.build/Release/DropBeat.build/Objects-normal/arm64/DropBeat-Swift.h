...
#ifndef DROPBEAT_SWIFT_H
#define DROPBEAT_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="DropBeat",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
# pragma pop_macro("any")
#endif

#if defined(__OBJC__)

SWIFT_CLASS("_TtC8DropBeat14AlwaysKeyPanel")
@interface AlwaysKeyPanel : NSPanel
...
SWIFT_CLASS("_TtC8DropBeat11AppDelegate")
...
@interface AppDelegate (SWIFT_EXTENSION(DropBeat)) <NSPopoverDelegate>
- (void)popoverWillShow:(NSNotification * _Nonnull)notification;
- (void)popoverDidClose:(NSNotification * _Nonnull)notification;
@end

SWIFT_CLASS("_TtC8DropBeat14CommandPalette")
@interface CommandPalette : NSObject
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end

@interface CommandPalette (SWIFT_EXTENSION(DropBeat)) <NSWindowDelegate>
